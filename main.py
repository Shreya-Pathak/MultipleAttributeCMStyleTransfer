...
def main():
	...
	logger.info(f"Loading available weights from : {model_args.model_name_or_path}")
	...
	logger.info("Initializing cmi_style_vector from previously trained model...")
	prev_trained_model = MT5ForStyleConditionalGeneration.from_pretrained("./models/mt5_hd_ft_cmi_vector/checkpoint-70000")
	model.cmi_style_vector = prev_trained_model.cmi_style_vector
